...
imageName1='plants_02.jpeg'
%imageName1='_MG_8080.JPG';

imageName4='plants_02.jpeg';
...
RGB=imread(fullfile(pathTestImages,imageName4));
I = rgb2lab(RGB);
...
% ------------------------------------
imwrite(IMsegmented4,fullfile(pathTestImages,'RESULT_01.jpg'));